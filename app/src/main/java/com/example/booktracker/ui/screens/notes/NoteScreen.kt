package com.shafiur.bibliophase.ui.screens.notes
...
fun NotesScreen(
    ...
    val books by produceState(initialValue = emptyList<com.shafiur.bibliophase.data.model.BookWithCategory>(), user) {
        user?.let {
...
@Composable
fun NoteItem(noteWithBook: com.shafiur.bibliophase.data.model.NoteWithBook, noteViewModel: NoteViewModel) {
...
fun AddNoteDialog(
    showDialog: Boolean,
    onDismiss: () -> Unit,
    books: List<com.shafiur.bibliophase.data.model.Book>,
    noteViewModel: NoteViewModel
) {
    var selectedBook by remember { mutableStateOf<com.shafiur.bibliophase.data.model.Book?>(null) }
                ...
                TextButton(onClick = {
                    selectedBook?.let {
                        noteViewModel.addNote(
                            com.shafiur.bibliophase.data.model.Note(
                                bookId = it.id,
                                content = content,
